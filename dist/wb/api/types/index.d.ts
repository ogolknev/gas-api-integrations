export namespace WB_API {
  namespace ProductManagment {
    namespace CategoriesAndSubjects {}
    namespace Tags {}
    namespace Nomenclatures {
      namespace NomenclaturesList {
        interface Query {
          locale: "ru" | "en" | "zh";
        }
        type RequestBody = {
    ...
    namespace TaxesAndLimits {}
    namespace ProductsCards {}
    namespace PricesAndDiscounts {
  ...
  namespace FBSOrders {}
  namespace FBWSupplies {}
  namespace MarketingAndPromotion {
  ...
  namespace CustomerCommunictaion {}
  namespace PricingPlans {}
  namespace AnalyticsAndData {
    namespace PromotionStatistics {
    ...
    namespace SalesFunnel {
      namespace ProductCardStatistics {
        type RequestBody = {
      ...
      namespace ProductCardStatisticsGrouped {}
      namespace ProductCardStatisticsHistory {
        type RequestBody = {
          nmIDs: Array<number>;
          period: {
            begin: string;
      ...
      namespace ProductCardStatisticsGroupedHistory {
        type RequestBody = {
          objectIDs?: Array<number>;
          brandNames?: Array<string>;
          tagIDs?: Array<number>;
